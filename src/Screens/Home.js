...
function Home(){
    return (
     ...
     <HomePageHeader />
       ...
       <div className="text-center font-heading mt-16 mb-10 text-3xl"><span className="text-green">T</span>rending Places</div>
       <div><Slides /></div>
       <div className="font-heading text-3xl mt-16 mb-10 text-center"><span className="text-green">T</span>rending Blogs</div>
       ...
       <div className="text-3xl text-center mt-16 mb-10"><span className="text-green">W</span>hy Choose Us?</div>
       <div className="flex flex-wrap justify-between md:px-32 px-2">
   <div><img src="/whychooseus1.svg" className="h-80 w-full md:block hidden" /></div>
     ...
     <div className="m"><h2 className="font-heading text-2xl font-light mb-6">Blogs by Travel <span className="text-green">Bloggers</span> </h2>
     <p className="w-96">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris...</p>
     </div>
     <div><img src="/whychooseus1.svg" className="h-80 w-full md:block hidden" /></div>
       </div>
       <div className="flex flex-wrap justify-between md:px-32 px-2 mt-16">
   <div><img src="/whychooseus3.svg" className="h-80 w-full md:block hidden" /></div>
     <div className=""><h2 className="font-heading text-2xl font-light mb-6">Blogs by Travel <span className="text-green">Bloggers</span> </h2>
     <p className="w-96">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris...</p>
     </div>
       </div>      
