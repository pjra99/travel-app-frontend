...
function Signin(){
 ...
 <div className="bg-black text-white pr-11 h-100 opacity-80 rounded-xl  mt-36 md:mt-28 mx-3 ">
   <div className="md:w-52 font-body mt-6 ml-10 text-lg">Login and explore your favourite destinations.</div>
   ...
   <button className=" mt-4 ml-2 p-2 rounded-md px-2 py-1 bg-blue flex h-14 md:h-10"><ImFacebook2 size={30} className="mt-0.5 -ml-0.5" /><span className="ml-1 mt-1.5 text-sm">Sign Up with Facebook</span></button>
   </div>
   <div className="mt-8 ml-10 md:ml-28">Don't have an account?<Link to="/signup"><span className="text-green"> Sign Up</span></Link></div>
   ...
   <button className="rounded-md text-center ml-10 md:w-96 p-2 border-darkgrey mt-4 bg-green"> Log In</button>
 </div>
   </div>
  </div>
    );
