function TextEditor({ title }) {
  return (
    <div className="flex-col justify-between mt-16 rounded-md border-2 border-lightgrey mx-36">
      ...
      <div className="h-12  bg-lightgreen flex flex-wrap  justify-between pl-4 rounded-b-md">
        <div className="pt-3 ">
          Font Size
        ...
        <div className="flex w-36 ml-10 flex-wrap justify-between">
          <button>
        ...
        <div className="flex w-36 ml-10 flex-wrap justify-between mr-10">
          <button>
